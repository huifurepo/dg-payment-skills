...
import hf.java.test1.ser.biz.dto.hostingpay.HostingPayQueryOrderReq;
...
public class HFPayController {
    ...
    @ResponseBody
    public Result<Map<String, Object>> queryorderinfo(@RequestBody HostingPayQueryOrderReq req) throws Exception {
        ...
        Map<String, Object> response = hostingpayService.queryOrderInfo(req.getHuifuId(), req.getOrgReqDate(), req.getOrgReqSeqId());
