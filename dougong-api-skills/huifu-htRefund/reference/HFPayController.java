...
import hf.java.test1.ser.biz.dto.hostingpay.HostingpayHtRefundReq;
...
public class HFPayController {
    ...
    @ResponseBody
    public Result<Map<String, Object>> htRefund(@RequestBody HostingpayHtRefundReq req) throws Exception {
        ...
        Map<String, Object> response = hostingpayService.htRefund(req.getHuifuId(), req.getOrdAmt(), req.getOrgReqDate(), req.getOrgReqSeqId());
