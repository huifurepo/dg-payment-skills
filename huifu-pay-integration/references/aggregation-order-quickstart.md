...
| `references/aggregation-payload-construction.md` | `method_expand` / 顶层扩展字段 / `tx_metadata` 参数校验与序列化规范 |
...
| `references/aggregation-order-tx-metadata.md` | 请求顶层字段、保留的 `tx_metadata` 入口、返回扩展对象的边界说明 |
